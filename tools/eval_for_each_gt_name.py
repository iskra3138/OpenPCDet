...
def parse_config():
    ...
    parser.add_argument('--iou', type=float, default=0.7, help='iou_threshold')    
...
def main():
    ...
    #cfg.MODEL.POST_PROCESSING.SCORE_THRESH = 0.3
    ...
    log_file = os.path.join(log_path, 'log_{}_{}.txt'.format(txt_name, name))
    ...
    f = open(os.path.join(log_path,'result_{}_{}.csv'.format(txt_name, name)), 'w')
